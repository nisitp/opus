...
<header class="header">
    <div class="header__contents">
		...
		<nav class="header__nav js-primary-nav">
            <div class="microsite-header-title"><?php the_title(); ?></div>
			<ul class="nav nav--utility nav--microsite-simple">
				<li class="nav__item u-hidden-tablet">
					<button data-modal="demo-modal" class="nav__button js-account-modal">Request a Demo</button>
				</li>
			</ul>
		</nav>
