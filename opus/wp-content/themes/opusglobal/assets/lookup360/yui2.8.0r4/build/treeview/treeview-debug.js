...
alert('Tree View constructor');
    if (id) { alert('Tree View init');this.init(id); }
    if (oConfig) {
  ...
  /**
    ...
    */
    ...
    init: function(id) {
		alert('init function');
        this._el = Dom.get(id);
		alert('init function this._el = ' + this._el);
        this.id = Dom.generateId(this._el,"yui-tv-auto-id-");
		alert('init function this.id = ' + this.id);
    ...
    */
		...
		alert('init function : after all create event');
        this._nodes = [];
